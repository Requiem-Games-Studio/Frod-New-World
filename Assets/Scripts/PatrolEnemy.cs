...
public class PatrolEnemy : MonoBehaviour
{
    ...
    void Shoot()
    {
        var projectil = Instantiate(projectilePrefab, firePoint.position, firePoint.rotation);
        projectil.gameObject.transform.localScale = new Vector3(direction,1,1);
    }
    void Shoot2()
    {
        var projectil = Instantiate(projectilePrefab, firePoint2.position, firePoint2.rotation);
        projectil.gameObject.transform.localScale = new Vector3(direction, 1, 1);
    }
